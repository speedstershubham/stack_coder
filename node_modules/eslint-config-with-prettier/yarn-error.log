Arguments: 
  /usr/local/Cellar/node@8/8.11.2/bin/node /usr/local/Cellar/yarn/1.7.0/libexec/bin/yarn.js upgrade-interactive --latest --force

PATH: 
  /usr/local/opt/node@8/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/marcel/Library/PackageManager/bin
...
Lockfile: 
  ...
  tough-cookie@>=2.3.3, tough-cookie@^2.3.3, tough-cookie@~2.3.0, tough-cookie@~2.3.2, tough-cookie@~2.3.3:
    version "2.3.3"
